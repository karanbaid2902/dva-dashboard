...
theme_styles = {
    "Light": "<style>.stMetric { background-color: #f0f2f6; padding: 15px; border-radius: 5px; color: #1f1f1f; border-left: 4px solid #FF9900; }</style>",
    "Dark": "<style>.stMetric { background-color: #1a1a1a; padding: 15px; border-radius: 5px; color: #ffffff; }</style>",
    "Ocean": "<style>.stMetric { background-color: #0a1428; padding: 15px; border-radius: 5px; color: #ffffff; border-left: 4px solid #0dcaf0; }</style>",
    "Forest": "<style>.stMetric { background-color: #0d3b1f; padding: 15px; border-radius: 5px; color: #ffffff; border-left: 4px solid #198754; }</style>",
    "Sunset": "<style>.stMetric { background-color: #3d1e2c; padding: 15px; border-radius: 5px; color: #ffffff; border-left: 4px solid #f66b6b; }</style>"
}
